...
uint32_t com_blocking_timeout[] = {
	SEND_BLOCKING_TIMEOUT_NONE,
	SEND_BLOCKING_TIMEOUT_USB,
	SEND_BLOCKING_TIMEOUT_SPI_STACK,
	SEND_BLOCKING_TIMEOUT_CHIBI,
	SEND_BLOCKING_TIMEOUT_RS485,
	SEND_BLOCKING_TIMEOUT_WIFI,
